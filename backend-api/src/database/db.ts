...
export const pool = new Pool({
  ...
  ssl: process.env.PGSSL === 'true' ? { rejectUnauthorized: false } : undefined, // PG is 127.0.0.1-only; opt-in PGSSL skips cert-verify by design (see SECURITY.md §PG SSL) — nosemgrep
