...
const TABLES: TableSpec[] = [
  ...
  },
  {
    ...
    label: 'Ledger TX Index',
    permission: [PermissionCode.AdminUsersManage],
    table: ledgerTxIndex,
    columns: [
      { id: 'serverSeq', label: 'Seq', type: 'number', col: ledgerTxIndex.serverSeq },
      { id: 'tableName', label: 'Таблица', type: 'string', col: ledgerTxIndex.tableName },
      { id: 'rowId', label: 'Row', type: 'string', col: ledgerTxIndex.rowId },
      { id: 'op', label: 'Операция', type: 'string', col: ledgerTxIndex.op },
      { id: 'payloadJson', label: 'Payload', type: 'json', col: ledgerTxIndex.payloadJson },
