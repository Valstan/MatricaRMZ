...
const TABLES: TableSpec[] = [
  {
    ...
    columns: [
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: entityTypes.syncStatus },
    ],
  },
  {
    name: 'entities',
    ...
    columns: [
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: entities.syncStatus },
    ],
  },
  {
    name: 'attribute_defs',
    ...
    columns: [
      ...
      { id: 'metaJson', label: 'Meta', type: 'json', col: attributeDefs.metaJson },
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: attributeDefs.syncStatus },
    ],
  },
  {
    name: 'attribute_values',
    label: 'Атрибуты (values)',
    permission: [PermissionCode.MasterDataView, PermissionCode.EnginesView, PermissionCode.PartsView, PermissionCode.EmployeesView, PermissionCode.SupplyRequestsView],
    ...
    columns: [
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: attributeValues.syncStatus },
    ],
  },
  {
    name: 'operations',
    ...
    columns: [
      ...
      { id: 'engineEntityId', label: 'Engine', type: 'string', col: operations.engineEntityId },
      ...
      { id: 'performedAt', label: 'Выполнено', type: 'datetime', col: operations.performedAt },
      { id: 'performedBy', label: 'Исполнитель', type: 'string', col: operations.performedBy },
      { id: 'metaJson', label: 'Meta', type: 'json', col: operations.metaJson },
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: operations.syncStatus },
    ],
  },
  {
    name: 'audit_log',
    ...
    columns: [
      ...
      { id: 'entityId', label: 'Entity', type: 'string', col: auditLog.entityId },
      { id: 'tableName', label: 'Таблица', type: 'string', col: auditLog.tableName },
      { id: 'payloadJson', label: 'Payload', type: 'json', col: auditLog.payloadJson },
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: auditLog.syncStatus },
    ],
  },
  {
    ...
    columns: [
      ...
      { id: 'rowId', label: 'Row', type: 'string', col: changeRequests.rowId },
      { id: 'rootEntityId', label: 'Root entity', type: 'string', col: changeRequests.rootEntityId },
      { id: 'beforeJson', label: 'Before', type: 'json', col: changeRequests.beforeJson },
      { id: 'afterJson', label: 'After', type: 'json', col: changeRequests.afterJson },
      { id: 'recordOwnerUserId', label: 'Owner ID', type: 'string', col: changeRequests.recordOwnerUserId },
      { id: 'recordOwnerUsername', label: 'Owner', type: 'string', col: changeRequests.recordOwnerUsername },
      { id: 'changeAuthorUserId', label: 'Author ID', type: 'string', col: changeRequests.changeAuthorUserId },
      { id: 'changeAuthorUsername', label: 'Author', type: 'string', col: changeRequests.changeAuthorUsername },
      ...
      { id: 'decidedByUserId', label: 'Decider ID', type: 'string', col: changeRequests.decidedByUserId },
      { id: 'decidedByUsername', label: 'Decider', type: 'string', col: changeRequests.decidedByUsername },
    ],
  },
  {
    name: 'change_log',
    ...
    table: changeLog,
    columns: [
      { id: 'serverSeq', label: 'Seq', type: 'number', col: changeLog.serverSeq },
      { id: 'tableName', label: 'Таблица', type: 'string', col: changeLog.tableName },
      { id: 'rowId', label: 'Row', type: 'string', col: changeLog.rowId },
      { id: 'op', label: 'Операция', type: 'string', col: changeLog.op },
      { id: 'payloadJson', label: 'Payload', type: 'json', col: changeLog.payloadJson },
      { id: 'createdAt', label: 'Создано', type: 'datetime', col: changeLog.createdAt },
    ],
  },
  {
    name: 'row_owners',
    ...
    columns: [
      ...
      { id: 'rowId', label: 'Row', type: 'string', col: rowOwners.rowId },
      { id: 'ownerUserId', label: 'Owner ID', type: 'string', col: rowOwners.ownerUserId },
      { id: 'ownerUsername', label: 'Owner', type: 'string', col: rowOwners.ownerUsername },
  ...
  },
  {
    ...
    table: syncState,
    columns: [
      { id: 'clientId', label: 'Client', type: 'string', col: syncState.clientId },
      { id: 'lastPulledServerSeq', label: 'Last pulled seq', type: 'number', col: syncState.lastPulledServerSeq },
      { id: 'lastPushedAt', label: 'Last pushed', type: 'datetime', col: syncState.lastPushedAt },
      { id: 'lastPulledAt', label: 'Last pulled', type: 'datetime', col: syncState.lastPulledAt },
    ],
  },
  {
    name: 'users',
    ...
    columns: [
      ...
      { id: 'passwordHash', label: 'Пароль (hash)', type: 'string', col: users.passwordHash },
  ...
  },
  {
    ...
    columns: [
      ...
      { id: 'userId', label: 'User', type: 'string', col: refreshTokens.userId },
      { id: 'tokenHash', label: 'Token hash', type: 'string', col: refreshTokens.tokenHash },
  ...
  },
  {
    ...
    columns: [
      ...
      { id: 'userId', label: 'User', type: 'string', col: userPermissions.userId },
      { id: 'permCode', label: 'Permission', type: 'string', col: userPermissions.permCode },
      { id: 'allowed', label: 'Allowed', type: 'boolean', col: userPermissions.allowed },
      { id: 'createdAt', label: 'Создано', type: 'datetime', col: userPermissions.createdAt },
    ],
  },
  {
    name: 'permission_delegations',
    label: 'Permission delegations',
    permission: [PermissionCode.AdminUsersManage],
    table: permissionDelegations,
    columns: [
      { id: 'id', label: 'ID', type: 'string', col: permissionDelegations.id },
      { id: 'fromUserId', label: 'From', type: 'string', col: permissionDelegations.fromUserId },
      { id: 'toUserId', label: 'To', type: 'string', col: permissionDelegations.toUserId },
      { id: 'permCode', label: 'Permission', type: 'string', col: permissionDelegations.permCode },
      ...
      { id: 'createdByUserId', label: 'Создал', type: 'string', col: permissionDelegations.createdByUserId },
      { id: 'revokedAt', label: 'Отозвано', type: 'datetime', col: permissionDelegations.revokedAt },
      { id: 'revokedByUserId', label: 'Отозвал', type: 'string', col: permissionDelegations.revokedByUserId },
  ...
  },
  {
    ...
    columns: [
      ...
      { id: 'mime', label: 'MIME', type: 'string', col: fileAssets.mime },
      { id: 'sha256', label: 'SHA256', type: 'string', col: fileAssets.sha256 },
      { id: 'storageKind', label: 'Storage', type: 'string', col: fileAssets.storageKind },
      { id: 'localRelPath', label: 'Local path', type: 'string', col: fileAssets.localRelPath },
      { id: 'yandexDiskPath', label: 'Yandex path', type: 'string', col: fileAssets.yandexDiskPath },
      { id: 'previewMime', label: 'Preview mime', type: 'string', col: fileAssets.previewMime },
      { id: 'previewSize', label: 'Preview size', type: 'number', col: fileAssets.previewSize },
      { id: 'previewLocalRelPath', label: 'Preview path', type: 'string', col: fileAssets.previewLocalRelPath },
  ...
  },
  {
    ...
    columns: [
      { id: 'clientId', label: 'Client', type: 'string', col: clientSettings.clientId },
      { id: 'updatesEnabled', label: 'Updates', type: 'boolean', col: clientSettings.updatesEnabled },
      ...
      { id: 'lastHostname', label: 'Hostname', type: 'string', col: clientSettings.lastHostname },
      { id: 'lastPlatform', label: 'Platform', type: 'string', col: clientSettings.lastPlatform },
      { id: 'lastArch', label: 'Arch', type: 'string', col: clientSettings.lastArch },
  ...
  },
  {
    ...
    columns: [
      ...
      { id: 'clientId', label: 'Client', type: 'string', col: diagnosticsSnapshots.clientId },
      { id: 'payloadJson', label: 'Payload', type: 'json', col: diagnosticsSnapshots.payloadJson },
  ...
  },
  {
    ...
    columns: [
      ...
      { id: 'senderUserId', label: 'Sender', type: 'string', col: chatMessages.senderUserId },
      { id: 'senderUsername', label: 'Sender name', type: 'string', col: chatMessages.senderUsername },
      { id: 'recipientUserId', label: 'Recipient', type: 'string', col: chatMessages.recipientUserId },
      ...
      { id: 'payloadJson', label: 'Payload', type: 'json', col: chatMessages.payloadJson },
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: chatMessages.syncStatus },
    ],
  },
  {
    name: 'chat_reads',
    ...
    columns: [
      ...
      { id: 'messageId', label: 'Message', type: 'string', col: chatReads.messageId },
      { id: 'userId', label: 'User', type: 'string', col: chatReads.userId },
      { id: 'readAt', label: 'Read at', type: 'datetime', col: chatReads.readAt },
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: chatReads.syncStatus },
    ],
  },
  {
    name: 'notes',
    ...
    columns: [
      ...
      { id: 'ownerUserId', label: 'Owner', type: 'string', col: notes.ownerUserId },
      { id: 'title', label: 'Заголовок', type: 'string', col: notes.title },
      { id: 'bodyJson', label: 'Body', type: 'json', col: notes.bodyJson },
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: notes.syncStatus },
    ],
  },
  {
    name: 'note_shares',
    ...
    columns: [
      ...
      { id: 'noteId', label: 'Note', type: 'string', col: noteShares.noteId },
      { id: 'recipientUserId', label: 'Recipient', type: 'string', col: noteShares.recipientUserId },
      { id: 'hidden', label: 'Hidden', type: 'boolean', col: noteShares.hidden },
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: noteShares.syncStatus },
    ],
  },
  {
    name: 'user_presence',
    ...
    columns: [
      ...
      { id: 'userId', label: 'User', type: 'string', col: userPresence.userId },
      ...
      { id: 'syncStatus', label: 'Sync', type: 'string', col: userPresence.syncStatus },
    ],
  },
];
