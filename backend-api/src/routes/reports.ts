...
const TABLES: TableSpec[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { id: 'entityId', label: 'Entity', type: 'string', col: changeRequests.entityId },
      ...
      { id: 'updatedAt', label: 'Обновлено', type: 'datetime', col: changeRequests.updatedAt },
      { id: 'deletedAt', label: 'Удалено', type: 'datetime', col: changeRequests.deletedAt },
      { id: 'syncStatus', label: 'Sync', type: 'string', col: changeRequests.syncStatus },
    ],
  },
  {
    name: 'change_log',
    ...
    table: changeLog,
    columns: [
      { id: 'id', label: 'ID', type: 'string', col: changeLog.id },
  ...
  },
  {
    ...
    table: syncState,
    columns: [
      { id: 'id', label: 'ID', type: 'string', col: syncState.id },
      { id: 'key', label: 'Ключ', type: 'string', col: syncState.key },
      { id: 'value', label: 'Значение', type: 'string', col: syncState.value },
      { id: 'updatedAt', label: 'Обновлено', type: 'datetime', col: syncState.updatedAt },
    ],
  },
  {
    name: 'users',
    ...
    columns: [
      ...
      { id: 'login', label: 'Логин', type: 'string', col: users.login },
  ...
  },
  {
    ...
    columns: [
      ...
      { id: 'token', label: 'Token', type: 'string', col: refreshTokens.token },
      ...
      { id: 'deletedAt', label: 'Удалено', type: 'datetime', col: refreshTokens.deletedAt },
    ],
  },
  {
    name: 'permissions',
  ...
  },
  {
    ...
    columns: [
      ...
      { id: 'updatedAt', label: 'Обновлено', type: 'datetime', col: userPermissions.updatedAt },
    ],
  },
  {
    ...
    columns: [
      ...
      { id: 'updatedAt', label: 'Обновлено', type: 'datetime', col: permissionDelegations.updatedAt },
    ],
  },
  {
    name: 'file_assets',
    ...
    columns: [
      ...
      { id: 'scopeOwnerType', label: 'Owner type', type: 'string', col: fileAssets.scopeOwnerType },
      { id: 'scopeOwnerId', label: 'Owner ID', type: 'string', col: fileAssets.scopeOwnerId },
      { id: 'scopeCategory', label: 'Категория', type: 'string', col: fileAssets.scopeCategory },
      { id: 'createdAt', label: 'Создано', type: 'datetime', col: fileAssets.createdAt },
      { id: 'updatedAt', label: 'Обновлено', type: 'datetime', col: fileAssets.updatedAt },
  ...
  },
  {
    ...
    columns: [
      { id: 'id', label: 'ID', type: 'string', col: clientSettings.id },
      { id: 'clientId', label: 'Client', type: 'string', col: clientSettings.clientId },
      { id: 'key', label: 'Ключ', type: 'string', col: clientSettings.key },
      { id: 'valueJson', label: 'Value', type: 'json', col: clientSettings.valueJson },
      ...
      { id: 'deletedAt', label: 'Удалено', type: 'datetime', col: clientSettings.deletedAt },
    ],
  },
  {
