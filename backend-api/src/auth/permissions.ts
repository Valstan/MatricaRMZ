...
export function defaultPermissionsForRole(role: string): Record<string, boolean> {
  ...
  // и один названный им сотрудник, пока больше никто»). Поэтому по умолчанию он есть только у
  ...
  // Этапы работ — тот же уклад (владелец 15.09.2026): строки заполняет и виды работ
