              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                ...
                <Button
                  onClick={async () => {
                    ...
                    const r = await adminUsers.createUser(newUser);
                  ...
                  <label style={{ display: 'flex', gap: 8, alignItems: 'center', color: '#111827', fontSize: 14 }}>
                    <input
                      ...
                      onChange={async (e) => {
                        ...
                        const r = await adminUsers.updateUser(selectedUserId, { isActive: e.target.checked });
                                ...
                                >
                                  ...
                                  <label style={{ display: 'flex', gap: 8, alignItems: 'center', justifyContent: 'flex-end' }}>
                                    ...
                                    <span className="muted" style={{ fontSize: 12 }}>
                                      {(disabled ? false : effective) ? 'вкл' : 'выкл'}
                                    </span>
                                  </label>
                                </div>
                              );
