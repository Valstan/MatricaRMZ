...
This file contains targeted, discoverable guidance for an AI coding agent working in this repository. Read `CLAUDE.md` (project rules) before doing anything invasive.
...
6. Safety & agent rules (strict)
   ...
   - Follow `CLAUDE.md` git flow: PR-only, report dirty trees, ask before destructive actions (force-push, reset, overwrite).
