...
export default [
  ...
  {
    ignores: ['**/dist/**', '**/build/**', '**/drizzle/**', '**/node_modules/**', '**/*.d.ts'],
  },
  {
    files: ['**/*.{js,mjs,cjs}'],
    languageOptions: {
    ...
    rules: {
      // Базовые правила — дальше будем расширять по пакетам.
      'no-console': 'off',
    },
  },
  {
    ...
    rules: {
      // В TS отключаем базовый no-undef/no-unused-vars в пользу TypeScript.
      'no-undef': 'off',
      'no-unused-vars': 'off',
      'no-redeclare': 'off',
