...
3. ~~Политика доступа~~ — ✅ 2026-08-03: **как у обычного клиента** («как у Сапегина» — токен + реплика, без device-gate), чтобы сразу вносить данные в документы. Серверный allowlist не заказываем.
