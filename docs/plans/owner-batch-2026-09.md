...
**Заведён:** 2026-09-08 · **Статус:** в работе (PR 1 отгружается)
...
| 2 | `feat/engine-list-filters-panel` | фильтры двигателей под одну кнопку + акт дефектовки/статус/цех/даты | ⏳ следующий |
| 3 | `feat/contract-list-filters-and-kind` | фильтры контрактов по всем полям карточки; военный/гражданский | ⏳ |
| 4 | `feat/list-search-exact-by-default` | точный поиск по умолчанию + кнопка «≈ Похожие» | ⏳ |
| 5 | `feat/engine-repair-history-editable` | история ремонта: автозапись + ручные строки + фильтрация по ней | ⏳ |
| 6 | `feat/shell-tabs-desktop-chat-badge` | порог вкладок 10; незакрываемые вкладки; подписи Верстака; колокольчик чата | ⏳ |
| 7 | `feat/app-close-unsaved-guard-and-update-progress` | закрытие с несохранёнными + прогресс обновления и «установить сейчас/позже» | ⏳ |
| 8 | `feat/employee-merge-service` | поиск дублей сотрудников и корректное слияние | ⏳ |
