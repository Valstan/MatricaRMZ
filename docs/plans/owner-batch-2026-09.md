...
**Заведён:** 2026-09-08 · **Статус:** в работе (шаги 1–3 на `main`, шаг 4 в PR)
...
| 5 | `feat/engine-repair-history-editable` | история ремонта: автозапись + ручные строки + фильтрация по ней | ⏳ следующий |
