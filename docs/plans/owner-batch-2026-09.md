...
**Заведён:** 2026-09-08 · **Статус:** в работе (шаг 1 на `main`, шаг 2 в PR)
...
| 3 | `feat/contract-list-filters-and-kind` | фильтры контрактов по всем полям карточки; военный/гражданский | ⏳ следующий |
