...
export const REPORT_PRESET_DEFINITIONS: ReportPresetDefinition[] = [
  ...
  },
  {
    ...
    title: 'Двигатели',
    description:
      'Все двигатели списком: панель ступеней (заказчик, договор, марка, цех, год и дата прихода, начало и окончание ремонта, отгрузка, состояние, этап на заводе, утиль, акт комплектности), настройка колонок, группировка по договору / марке / заказчику и печать. Объединяет прежние «Отчёт по двигателям» и «Двигатели и контракты».',
    filters: [],
    columns: [],
    presentation: 'list',
  },
