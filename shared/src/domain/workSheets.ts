...
export type WorkSheetRow = {
  ...
  /**
   * Номер прохода: 1 у обычной строки, 2+ у помеченной оператором как повторный проход.
   * Нужен в списке и отчётах, чтобы осознанный возврат было ВИДНО и он не читался как дубль —
