...
export type WorkSheetType = {
  ...
  /** Строка этой ведомости завершает ремонт: карточке ставится «Отремонтирован» с датой строки. */
...
/** Значение поля строки ведомости после нормализации по типу колонки. */
export type WorkSheetFieldValue = string | number | boolean | null;

/**
 * Поле строки ведомости: несёт подпись и тип с собой, чтобы строка читалась и без справочника
...
/**
 * Строка ведомости, как её видит экран «Ведомости работ»: запись истории плюс подписи двигателя.
...
/**
 * Ступени фильтра вкладки ведомости: общие (узел, марка, цех, исполнитель, дата) плюс
