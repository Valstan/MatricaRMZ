...
export function facetOptions<Row>(
  ...
  // то, что встретилось в строках сверх ряда (архивный вид работ у старого этапа).
...
/**
 * Потолок значения ступени. Равен потолку текстового поля этапа работ (`WORK_SHEET_MAX_TEXT`):
