export const PermissionCode = {
  ...
  // Этапы работ — отдельное право, а не operations.edit: заполняет их узкий круг
  // (решение владельца 15.09.2026), а правка истории ремонта есть у мастеров и бригадиров.
  // Чтение этапов работ остаётся на operations.view, который входит в базу оператора.
...
export const PERMISSION_CATALOG: PermissionMeta[] = [
  ...
  { code: PermissionCode.OperationsEdit, group: 'Операции', titleRu: 'Создание/редактирование операций (таймлайн)' },
  {
    ...
    group: 'Операции',
    titleRu: 'Этапы работ: заполнение строк',
    descriptionRu: 'Добавлять, править и удалять строки этапов работ. Роль права не даёт — выдаётся поимённо. Смотреть этапы работ могут все, у кого есть просмотр операций.',
  },
  {
