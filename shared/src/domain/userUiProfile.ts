...
export type UserUiProfile = {
  ...
  /**
   * «Верстак» (v3.7.0, этап 5 пакета 19.08б): ярлыки, папки, корзина,
   * раскладка сплитов экрана «чат + Верстак». LWW — секцией целиком.
   */
  desktop?: UserUiProfileDesktop;
  /**
   * Счётчик использования ярлыков Верстака (пакет 2026-08-20): по нему считается размер
