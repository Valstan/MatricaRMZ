...
/**
 * Опции «Виды работ» для фильтра отчёта «Ведомости работ». Источник — тот же серверный
 * справочник, что и у экрана: виды работ живут REST-таблицей, в реплике их нет.
 *
 * `value` — КОД вида работ, а не id: ведомость называет свой вид кодом (`sheet.typeCode`),
 * и отчёт отбирает по нему же. Архивные виды включены намеренно — их ведомости в истории
