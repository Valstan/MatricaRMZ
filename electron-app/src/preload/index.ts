...
const matricaApi = {
  ...
  reports: {
    ...
    popularFilters: async (args: { presetId: string }) => ipcRenderer.invoke('reports:popularFilters', args),
  ...
  admin: {
    ...
    users: {
      ...
      sectionAccessSetOne: async (userId: string, sectionId: string, level: 'viewer' | 'editor' | null) =>
        ipcRenderer.invoke('admin:users:sectionAccessSetOne', userId, sectionId, level),
  ...
  employees: {
    ...
    dedupeAnalyze: async () => ipcRenderer.invoke('employees:dedupeAnalyze'),
    dedupeMerge: async (args: { survivorId: string; loserId: string; dryRun?: boolean }) => ipcRenderer.invoke('employees:dedupeMerge', args),
  ...
  workSheets: {
    ...
    rows: {
      ...
      get: async (id: string) => ipcRenderer.invoke('workSheets:rows:get', id),
      search: async (args: { q: string; limit?: number }) => ipcRenderer.invoke('workSheets:rows:search', args),
  ...
  chat: {
    ...
    roomsList: async () => ipcRenderer.invoke('chat:roomsList'),
    roomSave: async (args: any) => ipcRenderer.invoke('chat:roomSave', args),
    roomDelete: async (args: any) => ipcRenderer.invoke('chat:roomDelete', args),
