...
/**
 * Последний удачный список узлов этапов работ — на случай офлайна: справочник живёт на сервере
 * (REST), а строки этапов работ самоописываемы и читаются без него. Кэш нужен лишь для того,
