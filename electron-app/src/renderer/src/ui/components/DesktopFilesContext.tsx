...
/**
 * Файловые ярлыки Верстака — для карточек.
 *
 * Контекст, а не проп: панель вложений рендерится из девяти страниц-карточек, а Верстак живёт
 * состоянием в App. Протаскивать проп через девять страниц — значит завести девять мест,
 * где его можно забыть.
 *
 * Направление важно. Не Верстак пишет в карточку, а карточка БЕРЁТ со Верстака и кладёт файл
...
/** Пусто — значит Верстака нет (планшет) или на нём нет файлов; кнопку «взять» не показываем. */
