...
const CLASSIC_PRESET: TypeSeed[] = [
  ...
  // «Цеха» намеренно НЕ сидятся как EAV entity-type: канон цеха — таблица
  // directory_workshops (см. docs/PROJECT_STATE.md). Легаси-тип workshop_ref
  // депрецирован; link-поля «цех» резолвятся на канон в AdminPage.refreshLinkOptions.
  {
    code: 'position_ref',
    name: 'Должности',
    defs: [
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'Детали', attrs: { kind: 'Изделия' } },
