...
export function MasterdataWorkshopsPage(props: { canManage: boolean }) {
        ...
        <table className="list-table" style={{ width: '100%' }}>
          <thead>
            <tr>
              ...
              <th>Название</th>
              <th style={{ width: 80, textAlign: 'center' }}>Активен</th>
              <th style={{ width: 110, textAlign: 'right' }}>Порядок</th>
