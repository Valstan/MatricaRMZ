...
import { describeAuditAction, type ChatDeepLinkPayload } from '@matricarmz/shared';
            ...
            {filteredRows.map((r) => {
              ...
              return (
                <tr key={r.id}>
                  ...
                  <td data-col-kind="text" style={{ padding: 8, borderBottom: '1px solid var(--border)' }}>{describeAuditAction(r)}</td>
