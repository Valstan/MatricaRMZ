...
└── scripts/
    ...
    ├── cdp-work-sheets.mjs        (смоук: «Ведомости работ» — вкладки узлов, строка обкатки диалогом → «Отремонтирован» датой строки, правка без дублей; убирает за собой; стенду нужна миграция 0097)
