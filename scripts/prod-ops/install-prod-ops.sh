...
echo "       sudo -Hu $MATRICA_USER /usr/local/sbin/matricarmz-backup-encrypted --no-upload   # builds + verifies, uploads nothing"
echo "       sudo -Hu $MATRICA_USER /usr/local/sbin/matricarmz-backup-encrypted               # full run, uploads + rotates"
